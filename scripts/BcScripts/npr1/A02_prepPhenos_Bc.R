...
#9. copy bash script: cp scripts/GEMMA_lesions/norand_GEMMA_kmatrix.sh */data/
#10. cd to data/BcTranscript/
...
Sys.time()
write.table(myFAM_match2, "data/BcTranscript/npr1/02_GEMMA/binMAF20NA10.fam", row.names=FALSE, col.names=TRUE)
Sys.time()
